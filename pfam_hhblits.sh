...
mpirun -np 160 ffindex_apply_mpi ${src_input}.ff{data,index} -i ${pfam_build_dir}/pfam_a3m_without_ss.ffindex -d ${pfam_build_dir}/pfam_a3m_without_ss.ffdata -- hhblits -i stdin -oa3m stdout -o /dev/null -cpu 1 -d ${uniprot} -n 3 -v 0
